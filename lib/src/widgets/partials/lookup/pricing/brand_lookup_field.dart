...
import 'package:redstars/src/utils/lookup/pricing/brand_lookup_dialog.dart';

class BrandTextField extends BaseLookupTextField {
  final int flag;
  final String vector;
  final bool isVector;
  ...
  @override
  BrandLookupState createState() => BrandLookupState();
}

class BrandLookupState
    extends BaseLookupState<BrandTextField, ItemGroupLookupItem> {
  @override
  Future<ItemGroupLookupItem> loadLookupData() {
    return brandLookupDialog(
      flag: widget.flag,
      context: context,
