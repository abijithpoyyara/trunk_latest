...
class ServiceLookupTextField extends BaseLookupTextField {
  final int flag;

  ServiceLookupTextField({
    bool isEnabled,
    String hint,
    String displayTitle,
    @required this.flag,
  ...
  @override
  ServiceLookupState createState() => ServiceLookupState();
}

class ServiceLookupState
    extends BaseLookupState<ServiceLookupTextField, ServiceLookupItem> {
  @override
