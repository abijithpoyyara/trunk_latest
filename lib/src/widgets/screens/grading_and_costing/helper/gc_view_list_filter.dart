...
class GCFilterDialog extends StatefulWidget {
  final GradingCostingViewModel viewModel;
  final GINFilterModel model;

  const GCFilterDialog({Key key, this.viewModel, this.model}) : super(key: key);

  @override
  _GCFilterDialogState createState() => _GCFilterDialogState(model);
}

class _GCFilterDialogState extends State<GCFilterDialog> {
  GINFilterModel model;
  final GlobalKey<FormState> _formKey = new GlobalKey<FormState>();

  _GCFilterDialogState(this.model);
